...
class ChemsSql(ChemsMisc):
    ...
    def populate_db(self):
        ...
        with psycopg2.connect(database=self.db_name) as conn, self._rich_progress() as progress:
            with conn.cursor() as cur:
                ...
                data = [(chem['cid'], syn) for chem in self.chems_mapped for syn in chem['cmpdsynonym'] if syn]
